...
class DemoApp(MDApp):
    def __init__(self, **kwargs):
        ...
        self.command_map = {
            "Antero-Posterior": "255,0,0",
            "Bipolar": "0,255,0",
            "Transverse": "0,0,255",
            "Infant": "255,255,255",
            "Sphenoidal": "255,0,255",
            "Brain Death": "0,255,255",
            "Hatband": "255,255,0",
            "EEG Electrodes": "225,245,2",
            "TBD": "0,0,0",
        }
   ...
   # Toggle card and send command when ElementCard is pressed 
    ...
    def on_start(self):     
        ...
        Clock.schedule_once(connect_and_scan, 0.7)
